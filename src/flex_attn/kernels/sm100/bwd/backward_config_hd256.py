...
from flex_attn.kernels.sm100.bwd.backward_dkdv_hd256 import (
...
_HD256_DQ_PAYLOAD_LAYOUT_ID = (
    "sm100_hd256_dq_tcgen05_qk_ld32x32b_r16_t128_v128_w4_ctarank2_axism_v1"
)
...
_HD256_DKDV_PAYLOAD_LAYOUT_ID = (
    "sm100_hd256_dkdv_tcgen05_kq_ld32x32b_r16_wg2_t256_v32_w1_qsub2_ctarank2_axisn_v1"
)
...
class _ResolvedSm100Hd256DqConsumerConfig:
    ...
    def plan_signature(self) -> ArbitraryPlanSignature:
        ...
        return ArbitraryPlanSignature(
            ...
            mma_atom_layout_id=(
                f"tcgen05_f32_ss_qk_cta2_m{topology.block_size[0]}"
                f"n{topology.block_size[1]}_major_kk"
            ),
            swap_ab=False,
...
class _ResolvedSm100Hd256DkdvConsumerConfig:
    ...
    def plan_signature(self) -> ArbitraryPlanSignature:
        ...
        return ArbitraryPlanSignature(
            ...
            qhead_per_kvhead=topology.qhead_per_kvhead,
            mma_atom_layout_id=(
                f"tcgen05_f32_ss_kq_cta2_m{topology.block_size[1]}"
                f"n{topology.block_size[0]}_major_kk"
            ),
            swap_ab=True,
            payload_layout_id=self.payload_layout_id,
            dq_order_format="none",
...
def resolve_sm100_hd256_dq_consumer_config(
    *,
    ...
    qhead_per_kvhead = (
        ...
        if type(num_q_heads) is int and type(num_kv_heads) is int and num_kv_heads > 0
        else 0
    )
