    ...
    def kernel(
        ...
        while batch_idx < batch_size:
            ...
            if const_expr(self.build_backward):
                ...
                mCuTotalBwdMBlocks[batch_idx + Int32(1)] = (
                    mCuTotalBwdMBlocks[batch_idx] + bwd_m_blocks
                )
                mCuTotalBwdNBlocks[batch_idx + Int32(1)] = (
                    mCuTotalBwdNBlocks[batch_idx] + bwd_n_blocks
                )
            batch_idx += Int32(1)
